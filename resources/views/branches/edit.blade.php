    ...
    <form action="{{ route('branches.update', $branch->id) }}" method="POST">
      ...
      <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <select class="form-select @error('marquee_id') is-invalid @enderror" id="marquee_id" name="marquee_id" required>
              @foreach($marquees as $marquee)
                <option value="{{ $marquee->id }}" {{ old('marquee_id', $branch->marquee_id) == $marquee->id ? 'selected' : '' }}>
        ...
        <div class="col-md-6">
          ...
          <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" type="text" value="{{ old('name', $branch->name) }}" required />
        ...
        <div class="col-md-6">
          ...
          <input class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" type="text" value="{{ old('phone', $branch->phone) }}" required />
        ...
        <div class="col-12">
          ...
          <input class="form-control @error('address') is-invalid @enderror" id="address" name="address" type="text" value="{{ old('address', $branch->address) }}" required />
        ...
        <div class="col-md-4">
          ...
          <select class="form-select @error('province') is-invalid @enderror" id="province" name="province" required>
            ...
            <option value="Punjab" {{ old('province', $branch->province) === 'Punjab' ? 'selected' : '' }}>Punjab</option>
            <option value="Sindh" {{ old('province', $branch->province) === 'Sindh' ? 'selected' : '' }}>Sindh</option>
            <option value="Khyber Pakhtunkhwa" {{ old('province', $branch->province) === 'Khyber Pakhtunkhwa' ? 'selected' : '' }}>Khyber Pakhtunkhwa</option>
            <option value="Balochistan" {{ old('province', $branch->province) === 'Balochistan' ? 'selected' : '' }}>Balochistan</option>
            <option value="Islamabad Capital Territory" {{ old('province', $branch->province) === 'Islamabad Capital Territory' ? 'selected' : '' }}>Islamabad Capital Territory</option>
          </select>
        ...
        <div class="col-md-5">
          ...
          <input class="form-control @error('fbr_pos_id') is-invalid @enderror" id="fbr_pos_id" name="fbr_pos_id" type="text" value="{{ old('fbr_pos_id', $branch->fbr_pos_id) }}" placeholder="e.g. PRA-LHR-GUL-01" />
        ...
        <div class="col-md-5">
          ...
          <input class="form-control @error('fbr_pos_key') is-invalid @enderror" id="fbr_pos_key" name="fbr_pos_key" type="password" value="{{ old('fbr_pos_key', $branch->fbr_pos_key) }}" placeholder="Key / Token secret" />
        ...
        <div class="col-md-2 d-flex align-items-center mt-md-4">
          <div class="form-check mb-0">
            <input class="form-check-input" type="checkbox" id="fbr_sandbox_mode" name="fbr_sandbox_mode" value="1" {{ old('fbr_sandbox_mode', $branch->fbr_sandbox_mode) ? 'checked' : '' }} />
      ...
      <div class="mt-4 d-flex justify-content-end gap-2">
        ...
        <button class="btn btn-primary btn-sm" type="submit">Update Branch</button>
      </div>
    </form>
  </div>
</div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      const oldProvince = "{{ old('province', $branch->province) }}";
