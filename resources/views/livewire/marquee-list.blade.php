                    ...
                    <tbody>
                        @forelse($marquees as $marquee)
                            <tr>
                                ...
                                <td class="align-middle">{{ $marquee->owners->first()->subscriptionPlan->name ?? 'None' }}</td>
                                <td class="align-middle">
                                    {{ $marquee->owners->first() && $marquee->owners->first()->subscription_ends_at ? $marquee->owners->first()->subscription_ends_at->format('M d, Y') : 'N/A' }}
                                </td>
                                <td class="align-middle text-center">
                                    @if($marquee->status === 'active')
                                        @if($marquee->owners->first() && $marquee->owners->first()->subscription_ends_at && $marquee->owners->first()->subscription_ends_at->isPast())
