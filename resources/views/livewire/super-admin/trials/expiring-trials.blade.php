<div>
    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-8">
            <h2 class="mb-1 text-primary fw-bold">Expiring & Expired Trials</h2>
            <p class="text-secondary fs-12 mb-0">Follow up on trial accounts expiring within the next 7 days or recently expired. Send email reminders or manually convert them.</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm border">
        ...
        <div class="card-header bg-light py-3 d-flex justify-content-between align-items-center">
            <div style="max-width: 300px; width: 100%;">
                <input wire:model.live="search" class="form-control form-control-sm" type="search" placeholder="Search expiring trials..." />
            </div>
            <span class="badge badge-subtle-warning fs-11">Total: {{ $expiringTrials->total() }} Expiring</span>
        </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle fs-12 mb-0">
                    ...
                    <tbody>
                        @forelse($expiringTrials as $account)
                            @php
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                        <span class="text-warning fw-bold">Expires in {{ max(0, $daysRemaining) }} Days</span>
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($isExpired)
                                    ...
                                    @else
                                        <span class="badge badge-subtle-warning">Expiring Soon</span>
                                    @endif
                                </td>
                                <td class="text-end pe-3">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-1">
                                            ...
                                            <button wire:click="sendReminder({{ $account->id }})" class="dropdown-item">
                                                <i class="fas fa-paper-plane me-2 text-info"></i>Send Email Reminder
                                            </button>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-4 text-muted">
                                    ...
                                    No expiring or expired trial accounts found.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        @if($expiringTrials->hasPages())
            <div class="card-footer bg-light py-2">
                {{ $expiringTrials->links() }}
            </div>
        @endif
    </div>
