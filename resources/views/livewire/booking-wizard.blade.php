                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="wizard_privacyRequired" wire:model.live="privacyRequired" />
                                    <label class="form-check-label fw-bold cursor-pointer" for="wizard_privacyRequired">Privacy / Partition Required?</label>
                                </div>
                            </div>
