<div class="container py-3">
    ...
    <div class="d-print-none card mb-3 bg-light">
        <div class="card-body d-flex justify-content-between align-items-center py-2">
            <span class="fs-12 text-700 fw-semi-bold">
                <span class="fas fa-info-circle me-1"></span>Use the button below or print page (Ctrl+P) to generate a PDF or paper copy (Version 3).
            </span>
    ...
    <div class="card bg-white shadow-none border p-4 p-md-5" id="printable-invoice">
        ...
        <!-- Event Menu Selection Details (Horizontal / 4 items per row) -->
        <div class="my-3">
            ...
            @if($booking->menuItems->isNotEmpty())
                <div class="row g-2 fs-12 text-800">
            ...
            @else
                <p class="text-muted fs-12 mb-0">No customized menu items selected.</p>
            @endif
        </div>

        <hr class="my-3" />

        <!-- Details and Extra Add-Ons / Special Setup (Horizontal Portions below Menu) -->
        <div class="row g-4 my-2">
            ...
            @if($booking->special_instructions)
                <div class="{{ $booking->extraServices->isNotEmpty() ? 'col-6' : 'col-12' }}">
