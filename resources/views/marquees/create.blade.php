...
@section('title', 'Add New Marquee')

@section('content')
<div class="card mb-3">
  <div class="card-header bg-light d-flex justify-content-between align-items-center">
    <h5 class="mb-0">Add New Marquee Tenant</h5>
  ...
  <div class="card-body">
    <form action="{{ route('marquees.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <input class="form-control @error('ntn') is-invalid @enderror" id="ntn" name="ntn" type="text" value="{{ old('ntn') }}" />
        ...
        <div class="col-md-4">
          ...
          <input class="form-control @error('strn') is-invalid @enderror" id="strn" name="strn" type="text" value="{{ old('strn') }}" />
        ...
        <div class="col-md-4">
          ...
          <select class="form-select @error('tax_authority') is-invalid @enderror" id="tax_authority" name="tax_authority" required>
            <option value="FBR" {{ old('tax_authority', 'FBR') === 'FBR' ? 'selected' : '' }}>FBR (Federal)</option>
            <option value="PRA" {{ old('tax_authority') === 'PRA' ? 'selected' : '' }}>PRA (Punjab)</option>
            <option value="SRB" {{ old('tax_authority') === 'SRB' ? 'selected' : '' }}>SRB (Sindh)</option>
            <option value="KPRA" {{ old('tax_authority') === 'KPRA' ? 'selected' : '' }}>KPRA (KPK)</option>
            <option value="BRA" {{ old('tax_authority') === 'BRA' ? 'selected' : '' }}>BRA (Balochistan)</option>
          </select>
        ...
        <div class="col-md-6">
          ...
          <input class="form-control @error('subscription_ends_at') is-invalid @enderror" id="subscription_ends_at" name="subscription_ends_at" type="date" value="{{ old('subscription_ends_at') }}" />
      ...
      <div class="mt-4 d-flex justify-content-end gap-2">
        ...
        <button class="btn btn-primary btn-sm" type="submit">Save Marquee</button>
      </div>
    </form>
  </div>
</div>
