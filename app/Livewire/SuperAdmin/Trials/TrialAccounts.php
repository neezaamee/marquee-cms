...
class TrialAccounts extends Component
{
    use WithPagination;
    ...
    public function convertToPaid()
    {
        ...
        DB::transaction(function() {
            ...
            $invoice = SaasInvoice::create([
                ...
                'notes' => 'Automatically generated upon conversion from trial account.',
            ]);
            ...
            $user->update([
                ...
                // Keep trial ends at for history/reference
                'status' => 'active',
            ]);
        });
    ...
    public function render()
    {
        ...
        $trialAccounts = $query->orderBy('subscription_trial_ends_at', 'desc')->paginate(10);
        $plans = SubscriptionPlan::orderBy('name')->get();
        $cycles = BillingCycle::orderBy('duration_in_months')->get();

        return view('livewire.super-admin.trials.trial-accounts', [
