...
return new class extends Migration
{
    ...
    {
        Schema::create('department_stock_ledgers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('transaction_type'); // Issue, Return, Consumption, Wastage, Adjust
    ...
    {
        Schema::dropIfExists('department_stock_ledgers');
    }
};
